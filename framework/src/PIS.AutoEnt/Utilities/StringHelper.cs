...
namespace PIS.AutoEnt
{
    ...
    public static class StringHelper
    {
        ...
        /// <returns></returns>
        public static string ToNullFilteredString(object orgValue, string newValue = "")
        {
        ...
        /// <returns></returns>
        public static string GetEmptyXmlNodeString(string rootName)
        {
            return String.Format(@"<{0} />", rootName);
        }
        ...
        public static string GetJsonString(object value, Formatting formatting = Formatting.None)
        {
